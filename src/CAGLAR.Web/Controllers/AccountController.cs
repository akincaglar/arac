...
using CAGLAR.Sessions;
using CAGLAR.Web.Controllers.Results;
using CAGLAR.Web.Models;
using CAGLAR.Web.Models.Account;
...
{
    public class AccountController : CAGLARControllerBase
    {
